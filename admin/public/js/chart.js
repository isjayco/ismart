...
Highcharts.chart('chart-top', {
    ...
    title: {
        text: 'Doanh số và danh thu bán hàng trong tháng',
        align: 'left'
    },
    subtitle: {
...
// ========= bottom 1 ============= //
Highcharts.chart('chart-bottom-1', {
    title: {
...
// ========= bottom 2 ============= //
Highcharts.chart('chart-bottom-2', {
    chart: {
        type: 'pie',
        options3d: {
            enabled: true,
