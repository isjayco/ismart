...
<div id="main-content-wp" class="update-post">
    ...
    <div id="content" class="fl-right" data-modules="products" data-modules_action="trademark" data-type="sub_trademark" data-id="<?php echo $trademark_id ?>">
                        ...
                        <div class="mx-auto modal-size">
                            <form class="modal-content overflow-auto" style="height: inherit" enctype="multipart/form-data" method="POST" id="content-update_info_post">
                                <div class="modal-header position-relative">
                                    <div class="title">
                                        <h4 class="main-title">
                                            <span>Danh sách sản phẩm thuộc thương hiệu "<?php echo $name_trademark ?>"</span>
                                ...
                                <div class="modal-body">
                                    ...
                                    ?>
                                        ...
                                        <div class="wp-table overflow-auto" style="max-height: 500px;">
                                            <table class="table main-content list-table-wp table-striped table-hover" data-table="table_products" data-action="" id="table">
                                                <!-- /auto load in php/ -->
                                            </table>
                                        </div>
